var OneTrustStub = (t => {
        ...
        for (; (u = l && e[(l = 0)] ? 0 : u); )
          try {
            if (
              ((o = 1),
              r &&
                (s = 2 & e[0] ? r.return : e[0] ? r.throw || ((s = r.return) && s.call(r), 0) : r.next) &&
                !(s = s.call(r, e[1])).done)
            )
              return s;
  ...
  var g = new (function () {
      ...
      (this.LOCATOR_NAME = '__gppLocator'),
        ...
        (this.init = function () {
          (r.win.__gpp && 'function' == typeof r.win.__gpp) ||
            ((r.win.__gpp = r.executeGppApi),
            window.addEventListener('message', r.messageHandler, !1),
            r.addFrame(r.LOCATOR_NAME));
        }),
        (this.removeGppApi = function () {
          delete r.win.__gpp;
          var t = document.querySelectorAll('iframe[name=' + r.LOCATOR_NAME + ']')[0];
          t && t.parentElement.removeChild(t);
        }),
        (this.executeGppApi = function () {
          for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
          var i = null == (i = r.win) ? void 0 : i.__gpp;
          if (
            ((i.queue = i.queue || []), (i.events = i.events || []), !t.length || (1 === t.length && 'queue' === t[0]))
          )
            return i.queue;
          ...
          switch (n) {
            ...
            case s.addEventListener:
              return r.addEventListener(a, o);
            case s.removeEventListener:
              return r.removeEventListener(o);
            default:
              return void r.addToQueue(n, a, o);
          }
        }),
        ...
        (this.addEventListener = function (t, e) {
          ...
          return (
            ...
            { eventName: 'listenerRegistered', listenerId: n.lastId, data: !0, pingData: r.getPingRequest() }
          );
        }),
        (this.removeEventListener = function (e) {
          ...
          return (
            ...
            { eventName: 'listenerRemoved', listenerId: e, data: i, pingData: r.getPingRequest() }
          );
        }),
    ...
    f =
      ((A.initCSPTrustedType = function (t) {
        ...
        window.DOMPurify &&
          ...
          (window.OtTrustedType.TrustedTypePolicy = window.trustedTypes.createPolicy('ot-trusted-type-policy', {
      ...
      A);
  function A() {}
  (v.prototype.initConsentSDK = function () {
    ...
    (v.prototype.captureNonce = function () {
      this.nonce = c.stubScriptElement.nonce || c.stubScriptElement.getAttribute('nonce') || null;
    }),
    (v.prototype.fetchBannerSDKDependency = function () {
      this.setDomainDataFileURL(),
        (this.crossOrigin = c.stubScriptElement.getAttribute('crossorigin') || null),
        (this.previewMode = 'true' === c.stubScriptElement.getAttribute('data-preview-mode')),
        this.otFetch(c.bannerDataParentURL, this.getLocation.bind(this));
    }),
    (v.prototype.setDomainIfBulkDomainEnabled = function (t) {
      ...
      e &&
        ...
        ((e = window.sessionStorage) && e.getItem('bulkDomainMgmtEnabled')
          ? this.handleBulkDomainMgmt({ isValid: 'true' === window.sessionStorage.getItem('bulkDomainMgmtEnabled') }, t)
          : ((n = { location: c.storageBaseURL.replace(/^https?:\/\//, ''), domainId: this.domainId, url: i }),
            this.otFetch(a, this.handleBulkDomainMgmt, !1, n, t)));
    }),
    (v.prototype.getLocation = function (t) {
      if (
        ...
        ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) || t.CookieV2CSPEnabled) &&
          this.nonce &&
          ((this.setAttributePolyfillIsActive = !0), new d().implementThePolyfill()),
        f.checkAndAssignCspTrustedTypeEnabled(t) && f.initCSPTrustedType(c.storageBaseURL),
        !t.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
      ...
      i.OneTrust && i.OneTrust.geolocationResponse
        ? ((i = i.OneTrust.geolocationResponse),
          ...
          this.addBannerSDKScript(t))
        : (i = this.readCookieParam(c.optanonCookieName, c.geolocationCookiesParam)) || t.SkipGeolocation
          ? ((e = i.split(';')[0]), (i = i.split(';')[1]), this.setGeoLocation(e, i), this.addBannerSDKScript(t))
          : this.getGeoLocation(t);
    }),
    (v.prototype.handleBulkDomainMgmt = function (t, e) {
    ...
    (v.prototype.getGeolocationURL = function (t) {
      t.TenantFeatures;
    ...
    (v.prototype.setGeoLocation = function (t, e, i) {
      c.userLocation = { country: t, state: (e = void 0 === e ? '' : e), stateName: (i = void 0 === i ? '' : i) };
    }),
    (v.prototype.otFetch = function (t, i, e, n, a) {
      ...
      if (new RegExp('^file://', 'i').test(t)) this.otFetchOfflineFile(t, i);
        ...
        if (
          ...
          r.open('GET', t),
          (r.withCredentials = !1),
          e && r.setRequestHeader('accept', 'application/json'),
          n)
        )
    ...
    (v.prototype.otFetchOfflineFile = function (t, e) {
    ...
    (v.prototype.jsonp = function (t, e, i, n) {
    ...
    (v.prototype.getRegionSet = function (t) {
      var e,
        i,
        n,
        a = c.userLocation,
    ...
    (v.prototype.validateIABGlobalScope = function () {
      ...
      t
        ? 'true' === t
          ...
          : ((c.hasIABGlobalScope = !1), (c.IABCookieValue = this.getCookie(c.oneTrustIABCookieName)))
        : (c.isStubReady = !1);
    }),
    (v.prototype.validateIABGDPRApplied = function () {
    ...
    (v.prototype.isBoolean = function (t) {
      return 'true' === t || 'false' === t;
    }),
    (v.prototype.readCookieParam = function (t, e) {
      var i,
        n,
        a,
        o,
      ...
      if (t) {
        for (n = {}, a = t.split('&'), i = 0; i < a.length; i += 1)
          (o = a[i].split('=')), (n[decodeURIComponent(o[0])] = decodeURIComponent(o[1]).replace(/\+/g, ' '));
        return e && n[e] ? n[e] : e && !n[e] ? '' : n;
      }
      return '';
    }),
    (v.prototype.getCookie = function (t) {
      if (this.isAmp) {
    ...
    (v.prototype.updateGtmMacros = function () {
      for (var t = [], e = c.optanonHtmlGroupData.length, i = 0; i < e; i++)
        this.endsWith(c.optanonHtmlGroupData[i], ':1') && t.push(c.optanonHtmlGroupData[i].replace(':1', ''));
      for (e = c.optanonHostData.length, i = 0; i < e; i++)
        this.endsWith(c.optanonHostData[i], ':1') && t.push(c.optanonHostData[i].replace(':1', ''));
      for (e = c.genVendorsData.length, i = 0; i < e; i++)
        this.endsWith(c.genVendorsData[i], ':1') && t.push(c.genVendorsData[i].replace(':1', ''));
      for (e = c.vendorsServiceData.length, i = 0; i < e; i++)
        this.endsWith(c.vendorsServiceData[i], ':1') && t.push(c.vendorsServiceData[i].replace(':1', ''));
      var n,
        ...
        r =
          (this.otDataLayer.ignore || void 0 === o[this.otDataLayer.name]
            ...
            : o[this.otDataLayer.name].constructor === Array &&
              (o[this.otDataLayer.name].push({ event: 'OneTrustLoaded', OnetrustActiveGroups: a }),
              o[this.otDataLayer.name].push({ event: 'OptanonLoaded', OptanonActiveGroups: a })),
      ...
      !this.otDataLayer.ignore &&
        ...
        setTimeout(function () {
          t.length && window.dispatchEvent(r), n && window.dispatchEvent(n);
        });
    }),
    (v.prototype.deserialiseStringToArray = function (t) {
      return t ? t.split(',') : [];
    }),
    (v.prototype.endsWith = function (t, e) {
      return -1 !== t.indexOf(e, t.length - e.length);
    }),
    (v.prototype.serialiseArrayToString = function (t) {
      return t.toString();
    }),
    (v.prototype.getStubQueryParam = function (t, e) {
      return !t || (t = t.split('?')).length < 2 ? null : new URLSearchParams(t[1]).get(e);
    }),
    (v.prototype.setStubScriptElement = function () {
      ...
      c.stubScriptElement && c.stubScriptElement.hasAttribute(c.DATAFILEATTRIBUTE)
        ? (this.domainId = c.stubScriptElement.getAttribute(c.DATAFILEATTRIBUTE).trim())
        : t
          ? (this.domainId = t)
          : c.stubScriptElement ||
            ((c.stubScriptElement = document.querySelector("script[src*='" + c.migratedCCTID + "']")),
            c.stubScriptElement && ((c.isMigratedURL = !0), (this.domainId = c.migratedDomainId.trim())));
    }),
    (v.prototype.setDomainDataFileURL = function () {
      var t = c.stubScriptElement.getAttribute('src'),
        e = -1 < t.indexOf('/consent');
      t &&
        (c.isMigratedURL
          ? (c.storageBaseURL = t.split('/consent/' + c.migratedCCTID)[0])
          : (c.storageBaseURL = (e ? t.split('/consent') : t.split('/scripttemplates/' + c.stubFileName))[0])),
        (this.storageBaseURL = c.storageBaseURL),
        this.isPreview && -1 === this.domainId.indexOf('test')
          ? (this.domainId = this.domainId + '-test')
          : (this.isPreview = !1),
        (c.bannerBaseDataURL = c.storageBaseURL && c.storageBaseURL + '/consent/' + this.domainId),
        (c.bannerDataParentURL = c.bannerBaseDataURL + '/' + this.domainId + '.json');
    }),
    ...
    (v.prototype.setGeoParam = function (t) {
      var e;
      t &&
    ...
    (v.prototype.updateVersion = function (t) {
      ('debug' !== this.buildType && 'cybuild' !== this.buildType) || (t.Version = '202508.1.0');
    });
  var y = v;
  function v() {
    var s = this;
    (this.iabType = null),
      ...
      (this.addBannerSDKScript = function (r) {
        return e(s, void 0, void 0, function () {
          var e, i, n, a, o;
          return u(this, function (t) {
            switch (t.label) {
              case 0:
                return ((e = this.getRegionSet(r)).GCEnable || (this.updateGtmMacros(), (this.gtmUpdated = !0)),
                this.iabTypeAdded &&
                  (('IAB2' !== e.Type && 'IAB2V2' !== e.Type) || ((this.iabType = e.Type), this.intializeIabStub()),
                  'IAB2' !== e.Type) &&
                  'IAB2V2' !== e.Type &&
                  this.removeTcf(),
                ...
                (n = r.UseSDKRefactor
                  ? (c.isMigratedURL &&
                      (i.src = c.storageBaseURL + '/scripttemplates/new/scripttemplates/' + c.stubFileName + '.js'),
                    c.storageBaseURL + '/scripttemplates/new/scripttemplates/' + r.Version + '/' + c.bannerScriptName)
                  : '5.11.0' === r.Version
                    ? (c.isMigratedURL &&
                        (i.src = c.storageBaseURL + '/scripttemplates/old/scripttemplates/' + c.stubFileName + '.js'),
                      c.storageBaseURL + '/scripttemplates/old/scripttemplates/5.11.0/' + c.bannerScriptName)
                    : (c.isMigratedURL && (i.src = c.storageBaseURL + '/scripttemplates/' + c.stubFileName + '.js'),
                      c.storageBaseURL + '/scripttemplates/' + r.Version + '/' + c.bannerScriptName)),
                [
                  'charset',
                  'data-language',
                ...
                c.stubScriptElement.getAttribute('integrity'))
                  ? ((o = r.CDNLocation + '/scripttemplates/' + r.Version + '/sri-hashes.json'),
              ...
              case 3:
                return (
                  ...
                  this.jsonp(n, null, !0, null == (o = a) ? void 0 : o['otBannerSdk.js']),
                  [2]
                );
            }
          });
  ...
  var b = new y();
  return (t.OtSDKStub = y), (t.otSdkStub = b), Object.defineProperty(t, '__esModule', { value: !0 }), t;
})({});
