/* xdoor-frontend: v0.2.308 (Thu, 28 Aug 2025 18:23:06 GMT) */
(function () {
  var PAYLOAD = {
    ENV: {
      widget: {
                  ...
                  : m && f
                    ...
                    : g && w[c] == l
                      ...
                      : v && 'function' == typeof l
                        ? i(Function.call, l)
                        : l),
              v && (((y.virtual || (y.virtual = {}))[c] = l), t & u.R && b && !b[c] && a(b, c, l)));
        };
        ...
        (t.exports = (function (t) {
          ...
          function (t, e, n) {
            ...
            e.default = function (t, e) {
              ...
              return !e || ('object' !== (void 0 === e ? 'undefined' : (0, i.default)(e)) && 'function' != typeof e)
                ? t
                : e;
            };
          },
          ...
          function (t, e, n) {
            t.exports = (function () {
              ...
              function m(t) {
                ...
                if (n && window && window.jet && 'error' === e.toLowerCase())
                  try {
                    throw new Error(t);
                  } catch (t) {
                    try {
              ...
              var g,
                y,
                b,
                w = 'aria-[a-z0-9_\\-]+|class|data-[a-z0-9_\\-]+|dir|id|role|tabindex',
                ...
                k = [
                  w,
                  'alt|checked|selected|colgroup|cols|colspan|disabled|height|hidden|maxlength|method|multiple|name|placeholder|readonly|rel|required|rows|rowspan|spellcheck|target|title|width',
                  'border|caption|color|controls|coords|hreflang|label|lang|loop|marginheight|marginwidth|preload|reversed|type|usemap|clear|headers|ismap|start|datetime|accept|max|min|size|step|style|cellspacing|cellpadding|attributionsrc',
                ].join('|'),
                S = o(function t() {
                  n(this, t);
                });
                  ...
                  t.forEach(function (t, a) {
                    (e = t.tags || _),
                      ...
                      r &&
                        (i += '|(?:'
                          .concat('href|src', ')=(["\'])(?:(?:')
                          .concat('https?|ftp|mailto|invalid', ')(?::|&#(?:58|x3a);)|(?:')
                          .concat(
                            'data:image/(?:gif|jpg|jpeg|png);base64,',
                            ')|[/.#?]|&#(?:35|4[67]|63|x(?:2[3ef]|3f));)[^\'"<>]*\\',
                          )
                          .concat(++o)),
                      (i += ')[ \t\r\n]*)+'),
                      (i += ')');
              ...
              function E(t) {
                return O({ tags: (t = t || _), checkUrlAttrs: !0 });
              }
              function A(t, e) {
                if (
                  !(function (t) {
                ...
                return n && n.length > 0
                  ? !E(n).test(t)
                  : r
                    ? !A.R_UNSAFE_CUSTOM_ELEMENT.test(t)
                    : !A.R_UNSAFE_HTML.test(t);
              }
              function I(t) {
                return t.replace(/<[^>]*>|[<>'"&\\]/g, '');
              }
              function j(t, e) {
                ...
                return (
                  A(n, e) ||
                    ((r = I(r)),
                    m('Content contains tags or attributes that are not allowed:\nContent: ' + n, 'error')),
                  r
                );
              }
              (A.R_UNSAFE_HTML = E()),
                (A.R_UNSAFE_CUSTOM_ELEMENT = O([
                  { tags: _, checkUrlAttrs: !0 },
                  {
                    tags: [(b = { tag: 'li-icon', attrs: 'active|a11y-text|animate|color|size|type' }).tag],
                    ...
                    H(
                      (function () {
                        ...
                        return String(null != t ? t : '').replace(
                          /(^[\0- ]*j\s*a\s*v\s*a\s*s\s*c\s*r\s*i\s*p\s*t\s*):/i,
                          '$1​:',
                        );
                      })(r),
                    )
              ...
              function R(t) {
                ...
                return (function (t, e) {
                  return (
                    Array.isArray(t) &&
                    Object.prototype.hasOwnProperty.call(t, 'raw') &&
                    Object.isFrozen(t) &&
                    t.length === e.length + 1
                  );
                })(t, n)
                  ? String.raw.apply(String, [{ raw: t }].concat(p(D(n))))
                  : B.apply(void 0, [t].concat(n));
              }
              function F() {
              ...
              function H(t) {
                return null === (null != t ? t : null)
                  ? null
                  : String(t).replace(z, function (t) {
                      return G[t];
                    });
              }
              var V = /&(?:([a-z0-9]+)|#x([\da-f]{1,6})|#(\d{1,8}));/gi,
                W = { nbsp: ' ', lt: '<', gt: '>', amp: '&', quot: '"', apos: "'" };
              function K(e) {
                return null === (null != e ? e : null)
                  ? null
                  : String(e).replace(V, function (e, n, r, o) {
                      return n
                        ? (function (e) {
                            if (t(W, e)) return W[e];
                        ...
                        : r || o
                          ? String.fromCodePoint(parseInt(r || o, r ? 16 : 10) || 65533)
                          : '�';
                    });
              }
              var Y = {
                  ...
                  if ((r = t[o]))
                    if ('string' == typeof r) {
                      ...
                      if (void 0 !== c) {
                        ...
                        for (Z(n, l[1] + r + l[2]), i = l[0]; i--; )
                          n && n.lastChild && n.lastChild.nodeType === Node.ELEMENT_NODE && (n = n.lastChild);
              ...
              var J = (function (t) {
                  ...
                  function r(t) {
                    ...
                    return (
                      n(this, r),
                      ((o = e.call(this)).options = i),
                      (o.tags = o.options.allowTags ? o.options.allowTags.flat() : []),
                      (o.str = t),
                      o
                    );
                  }
                ...
                rt = /([/\\]|^)([.]|%2e){2}([/\\]|$)/i,
                ot = new RegExp(
                  '^(?:HTTPS?|https?|ftp|mailto|tel|sms|blob|voyager|android-app|linkedin|chrome-extension|invalid|data:(?:(?:image/(?:gif|jpe?g|png|webp|bmp|tiff))|(?:application/x-font-woff)|(?:font/(?:opentype|ttf)))[;,]|[/.#?])',
                );
              function it(t) {
                var e;
                ...
                if (
                  ((e = t.trim()).indexOf(' ') > -1 &&
                    (m('jSecure Warning: url should not contain spaces: ' + t, 'warn'), (e = e.replace(tt, '+'))),
                  !ot.test(e))
                )
                  return (
                    m(
                ...
                if (et.test(e))
                  return m('jSecure Error: not valid url character found in url: ' + t, 'error'), 'invalid://';
                var n,
                  r = e.split('?')[0],
                  o = !1;
                if (r) {
                  try {
                    if (((n = decodeURI(r)), rt.test(n)))
                      return m('jSecure Error: malicious data found in url path: ' + r, 'error'), 'invalid://';
                  } catch (t) {
                    o = !0;
                  }
                  if (o) return m('jSecure Error: malformed url path detected: ' + r), 'invalid://';
                  if (nt.test(r) || rt.test(r))
                    return m('jSecure Error: malicious data found in url path: ' + r, 'error'), 'invalid://';
                }
                return t;
              }
              ...
              return {
                      ...
                      t.forEach(function (t, e) {
                        ...
                        (i += t),
                          e < a &&
                            ((o = n[e]) instanceof J
                              ? (i += o)
                              : (i += H(String(null !== (r = o) && void 0 !== r ? r : ''))));
                      }),
                    ''.concat(j(i))
                  );
                },
                ...
                parseHTML: function (t, e) {
                  ...
                  if (
                    ((e =
                      e || (document.implementation && document.implementation.createHTMLDocument)
                ...
                UnsafeString: function t(e) {
                  ...
                  return (
                    this instanceof t || console.warn("Calling 'UnsafeString' without the 'new' keword is deprecated"),
                    new J(e, n)
                  );
                },
              };
          ...
          function (t, e, n) {
            ...
            function c(t) {
              ...
              return (
                ...
                /^(?:HTMLCollection|NodeList|Object)$/i.test(e) &&
                'number' == typeof t.length &&
                (0 === t.length || ('object' === a()(t[0]) && t[0].nodeType > 0))
              );
            }
            function f(t, e, n) {
          ...
          function (t, e, n) {
            ...
            var r = n(0),
              ...
              a = n(9);
            e.a = function t(e) {
              return o()(this, t), (e = Object(i.sanitizeUrl)(e)), Object(a.a)('a', { href: e });
            };
          },
          function (t, e, n) {
            'use strict';
          ...
          function (t, e, n) {
            ...
            function E(t) {
              (
                O ||
                ((O = Object(g.a)('div', { id: _()(), class: 'IN-staging', styles: { display: 'none' } })),
            ...
            var A = /^(?:POST|GET)$/i,
              ...
              T = function t(e, n) {
                ...
                if (
                  ...
                  (this.params = d()({}, o || {}, { xdOrigin: c, xdChannel: f, xd_origin_host: c })),
                  i && i.call(this, this.params),
                  !1 !== u)
                ) {
                  var l = Object(P.a)();
                  l &&
                    l.events.on('refresh', function () {
                      r.reload();
                    });
                }
              };
            function M() {
              if (this.useFormSubmission) {
                var t = (function () {
                  var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                  t = d()({ action: './', params: {}, method: 'auto', target: null }, t);
                  ...
                  return (
                    b()(e).forEach(function (t) {
                      var n = e[t];
                      if (void 0 !== n) {
                        var r = Object(g.a)('input', { type: 'hidden', name: t, value: n });
                        s.appendChild(r);
                      }
                    }),
                    E(s),
                  ...
                  action: Object(k.a)(this.src, { xdOrigin: this.params.xdOrigin, xdChannel: this.params.xdChannel }),
                  target: this.id,
                  params: this.params,
                  method: this.method,
                });
            ...
            var D = (function (t) {
                function e(t) {
                  ...
                  r.type = 'popup';
                  var i = d()({ width: n.width || 500, height: n.height || 400 }, n.attributes || {}),
                    a = Object(I.a)(i, ', ');
              ...
              l = (function (t) {
                function e(t, n) {
                  ...
                  switch (((n = n || t.src), t.type)) {
                    case 'popup':
                      var i = u()(this, (e.__proto__ || o()(e)).call(this, { target: t.self, origin: n, channel: r }));
                      break;
                    default:
                      var s = t.self;
                      (i = u()(
                        this,
                        (e.__proto__ || o()(e)).call(this, { target: s.contentWindow, origin: n, channel: r }),
                      )).on('ready', function () {
          ...
          function (t, e, n) {
            ...
            t.exports = function (t, e, n, h, v, m, g) {
              ...
              if (
                ...
                if (((y = { values: k ? A : x('values'), keys: m ? A : x('keys'), entries: I }), g))
              ...
              d = (function () {
                function t(e, n) {
                  o()(this, t),
                    ...
                    (this.attributes = new c(e, { prefix: n.options.get('dataNamespace') })),
                    Object(f.b)(this.node, e),
                  ...
                  u()(t, [
                    {
                      ...
                      value: function () {
                        ...
                        return new t(
                          o()({}, this.options, { namespace: [this.options.namespace].concat(n).join(':') }),
                        );
                      },
                    },
                    {
          ...
          function (t, e, n) {
            ...
            function y(t, e, n) {
              if (this.isAttached) {
                ...
                var o,
                  i = [e && this.logger.message(e), n].filter(Boolean);
            ...
            var b = (function (t) {
              function e() {
                ...
                return (t.records = []), (t.logger = new g.a({ namespace: 'IN:Debugger' })), (t.isAttached = !1), t;
              }
              return (
                d()(e, t),
                u()(e, [
            ...
            ((e = t.exports =
              function (t, e, n, l, d) {
                ...
                if (i(g)) {
                  ...
                  for (v = g.call(t); !(h = v.next()).done; ) if ((m = o(v, y, h.value, e)) === c || m === f) return m;
              }).BREAK = c),
              (e.RETURN = f);
          },
          function (t, e, n) {
                  ...
                  d()(e, [
                    {
                      ...
                      value: function (t) {
                        ...
                        n
                          ? (this.promise[t] = new o.a(function (n) {
                              e[t] = function () {
                    ...
                    },
                    {
                      ...
                      value: function (t, n) {
                        this.promise[t]
                          ? this.promise[t].then(n)
                          : m()(e.prototype.__proto__ || u()(e.prototype), 'on', this).call(this, t, n);
                      },
                    },
                    {
                      key: 'once',
                      value: function (t, n) {
                        this.promise[t]
                          ? this.promise[t].then(n)
                          : m()(e.prototype.__proto__ || u()(e.prototype), 'once', this).call(this, t, n);
                      },
                    },
                  ]),
                  e
                ...
                from: function (t) {
                  ...
                  if ((m && (v = r(v, h > 2 ? arguments[2] : void 0, 2)), null == y || (p == Array && s(y))))
                    ...
                    for (l = y.call(d), n = new p(); !(o = l.next()).done; g++)
                      c(n, g, m ? a(l, v, [o.value, g], !0) : o.value);
                  return (n.length = g), n;
                },
              },
            );
          ...
          function (t, e, n) {
            ...
            var r = n(10),
              ...
              Q = function (t, e, n) {
                return (
                  ...
                  o(U, e)
                    ? (n.enumerable
                        ? (o(t, D) && t[D][e] && (t[D][e] = !1), (n = S(n, { enumerable: k(0, !1) })))
                        : (o(t, D) || C(t, D, k(1, {})), (t[D][e] = !0)),
                      K(t, e, n))
                    : C(t, e, n)
                );
              },
              ...
              J = function (t) {
                for (var e, n = P(x(t)), r = [], i = 0; n.length > i; )
                  o(U, (e = n[i++])) || e == D || e == u || r.push(e);
                return r;
              },
              tt = function (t) {
                for (var e, n = t === G, r = P(n ? z : x(t)), i = [], a = 0; r.length > a; )
            ...
            H ||
              (s(
                (T = function () {
                  ...
                  return i && W && K(G, t, { configurable: !0, set: e }), Y(t);
                }).prototype,
                'toString',
                function () {
                  return this._k;
              ...
              (n(42).f = $),
              (A.f = tt),
              i && !n(32) && s(G, 'propertyIsEnumerable', $, !0),
              (h.f = function (t) {
                return Y(p(t));
              })),
            ...
            a(a.S + a.F * it, 'Object', {
              ...
              T.prototype[B] || n(20)(T.prototype, B, T.prototype.valueOf),
              l(T, 'Symbol'),
              l(Math, 'Math', !0),
              l(r.JSON, 'JSON', !0);
          },
            ...
            t.exports = {
              set:
                ...
                ('__proto__' in {}
                  ? (function (t, e, r) {
                      try {
                        (r = n(23)(Function.call, n(64).f(Object.prototype, '__proto__').set, 2))(t, []),
          ...
          function (t, e, n) {
            t.exports = { default: n(171), __esModule: !0 };
          },
          function (t, e, n) {
            'use strict';
            n.d(e, 'a', function () {
            ...
            var r = n(2),
              ...
              p = (function (t) {
                function e(t) {
                  ...
                  var r = u()(this, (e.__proto__ || o()(e)).call(this, 'xdoor-icon', { 'aria-hidden': !0 }));
            ...
            var r = n(2),
              ...
              v = (function (t) {
                function e() {
                  ...
                  return (
                    !1 !== s && (s = s || new d.a('in-bug')).appendTo(v.node),
          ...
          function (t, e, n) {
                  ...
                  u()(t, [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        return !(
                          !(t = this.parse(t)) ||
                          t.jsonrpc !== this.defaults.jsonrpc ||
                          !(t.method || t.error || 'result' in t) ||
                          S()(this.metaData).some(function (n) {
                    ...
                    },
                    {
                      key: 'format',
                      value: function (t, e) {
                        return E()({}, this.defaults, { id: e || null }, t);
                      },
                    },
                  ]),
                  t
            ...
            var F = (function () {
                function t(e) {
                  ...
                  a()(this, t),
                    ...
                    e.channel && this.validateChannel(e.channel),
                    (this.channel = e.channel || I()()),
                    (this.jsonRPC = new P({ channel: this.channel, context: 'Messenger' })),
                    (this.emitter = new M.a()),
                    ...
                    window.addEventListener('message', R.bind(this));
                }
                return (
                  u()(t, [
                    {
                      key: 'validateChannel',
                      value: function (t) {
                        if (t && !/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(t))
                          throw new Error('[Messenger] Invalid channel. Must be a valid id.');
                      },
                    },
                  ]),
                  u()(t, [
                    {
                      ...
                      value: function (t, e) {
                        ...
                        return (
                          e &&
                            this.emitter.on('message', function (r) {
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        return this.jsonRPC.isValid(i)
                          ? (this.target.postMessage(y()(i), this.origin), i)
                          : (console.error('Could not emit invalid message', i), null);
                      },
                    },
                    {
                      key: 'response',
            ...
            var G = (function (t) {
              function e(t) {
                ...
                return (
                  (n.messenger = new F({ origin: Object(D.a)(t.origin), target: t.target, channel: t.channel })),
                  n.messenger.on(
                    'ready',
                    function (t) {
                      var e = this,
                      ...
                      z.call(this)
                        ...
                        : ((this.readyData = n),
                          t &&
                            t.supported &&
                            (t.supported.methods &&
                              t.supported.methods.forEach(function (t) {
                                e[t] = function () {
                            ...
                            t.supported.events &&
                              t.supported.events.forEach(function (t) {
                ...
                u()(e, [
                  ...
                  },
                  {
                    ...
                    value: function (t, n) {
                      'ready' === t && z.call(this)
                        ? n(this.readyData)
                        : d()(e.prototype.__proto__ || o()(e.prototype), 'on', this).call(this, t, n);
                    },
                  },
                  {
                    key: 'once',
                    value: function (t, n) {
                      'ready' === t && z.call(this)
                        ? n(this.readyData)
                        : d()(e.prototype.__proto__ || o()(e.prototype), 'once', this).call(this, t, n);
                    },
                  },
                ]),
                e
            ...
            !(function () {
              ...
              function c(t, e) {
                ...
                function p() {
                  ...
                  c))
                    c.hasOwnProperty(s) && (this[s] = d(s, e));
                  for (s in (this.Parents.push('constructor'), (u = o.apply(this, arguments)), this.Parents.pop(), c))
                    c.hasOwnProperty(s) && (this[s] = d(s, e));
                  return u;
                }
                (this.Implements = function () {
                  ...
                  for (var e = 0, n = arguments.length; e < n; e++)
                    if ('array' === Object.prototype.toString.call(arguments[e]).slice(8, -1).toLowerCase())
                      ...
                      arguments[e].indexOf('.') >= 0
                        ? this.Implements(s(arguments[e]))
                        : this.getMethod(arguments[e]) || this.Method(arguments[e], t(arguments[e]));
                  return this;
                }),
              ...
              function o(e) {
                ...
                var a,
                  ...
                  v =
                    ...
                    (d = 0),
                    (p = 0),
                    (h = 'BackCompat' === document.compatMode),
                    r.iosAll.test(a)
                      ? ((p = 1), (s = 1), r.ios5.test(a) ? (l = 1) : r.ios6.test(a) && (d = 1))
                      : r.webkit.test(a)
                        ? (s = 1)
                        : r.opera.test(a)
                          ? (c = 1)
                ...
                function m() {
                  ...
                  return (
                    ((t = { width: window.self.innerWidth, height: window.self.innerHeight }).width && t.height) ||
                      (t.width && t.height) ||
                      ((!e && !v.isIE()) ||
                        v.isOpera() ||
                        (t.height =
                          'CSS1Compat' === e ? document.documentElement.clientHeight : document.body.clientHeight),
                      (e || v.isIE()) &&
                        (t.width =
                          'CSS1Compat' === e ? document.documentElement.clientWidth : document.body.clientWidth)),
                    t
                  );
                }
                function g(t) {
                  if (t === document.body)
                    return (
                      (r = document.body),
                      (o = r.style.overflow),
                      v.isGecko() && (r.style.overflow = 'auto'),
                      (e = r.scrollWidth),
                      (n = r.clientHeight),
                      v.isGecko() && (r.style.overflow = o),
                      { width: e, height: n, scrollHeight: r.scrollHeight }
                    );
                  var e,
                    n,
                    r,
                ...
                function y(t) {
                  ...
                  return (
                    a < 0 && (a = 0), i < 0 && (i = 0), { top: a, right: i + o.width, bottom: a + o.height, left: i }
                  );
                }
                function b(t) {
                ...
                e.Objects.Lib = {
                  ...
                  anchor: function (t, e, n) {
                    for (
                      var r = i(t),
                        ...
                        s = m(),
                        u = g(document.body),
                        c = Math.max(s.width || 0, u.width || 0, r.x + r.width || 0),
                        f = Math.max(s.height || 0, u.height || 0, u.scrollHeight || 0, r.y + r.height || 0),
                        l = null,
                        d = 0,
                        p = 0,
                        h = 0,
                  ...
                  slideTo: function (t, e) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                      r = w((n = { duration: n.duration || 700, bounce: n.bounce || 0.2 }).duration),
                      o = b(t),
                      i = { top: e.top - o.top, left: e.left - o.left },
                      a = r.total;
                    if (n.bounce) {
                      var s = { top: 2 * n.bounce * i.top, left: 2 * n.bounce * i.left },
                        u = { top: 0, left: 0 };
                      (i.top += s.top),
                        (i.left += s.left),
                        0 !== i.top && (u.top = Math.abs(s.top / i.top)),
                        0 !== i.left && (u.left = Math.abs(s.left / i.left)),
                        (u = Math.max(u.top, u.left)),
                        (a = (1 - u) * r.total);
                    }
                    var c = (1 + r.total) * (r.total / 2);
                    n.bounce && (c *= 1 - 2 * n.boucne),
                      (i.top = i.top / c),
                      (i.left = i.left / c),
                      (function e() {
                        r.total > 0 &&
                  ...
                  setShadowBox: function () {
                    ...
                    if (t.shadowBox.node) a = t.shadowBox.node;
                      ...
                      x((a = t.shadowBox.node = document.createElement('div'))),
                        ...
                        e.Util.addCSS(
                          [
                            ...
                            "-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=" +
                              ...
                              ")'" +
                              o,
                            'filter: alpha(opacity=' + 100 * r.altOpacity + ')' + o,
                            '-moz-opacity: ' + r.altOpacity + o,
                            'opacity: ' + r.altOpacity + o,
                            '}',
                            ,
                            '',
                          ].join(''),
                        ...
                        e.Util.addCSS(
                          [
                            '',
                            '#' + s + ' { ',
                            'position: ' + (v.isQuirksMode() && v.isIE() ? 'absolute' : 'fixed') + o,
                            "-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=" +
                              100 * r.opacity +
                              ")'" +
                              o,
                            'filter: alpha(opacity=' + 100 * r.opacity + ')' + o,
                            '-moz-opacity: ' + r.opacity + o,
                            'opacity: ' + r.opacity + o,
                            'background-color: ' + r.color + o,
                            'z-index: ' + r.zIndex + o,
                            'top: 0' + o,
                            'left: 0' + o,
                            '}',
                    ...
                    function l() {
                      var t = m(),
                        e = g(document.body);
                      (a.style.width = Math.max(e.width, t.width) + 'px'),
                        (a.style.height = Math.max(e.height, e.scrollHeight, t.height) + 'px');
                    }
                  },
                };
              }
          ...
          function (t, e, n) {
                          ...
                          },
                          {
                            ...
                            value: function () {
                              ...
                              switch (
                                ...
                                case 'after':
                                  o.nextSibling
                                    ? o.nextSibling.parentNode.insertBefore(i, o.nextSibling)
                          ...
                          },
                          {
                            ...
                            value: function (t) {
                              ...
                              if (!e) {
                                ...
                                e = n.userAgents.webkit.test(a)
                                  ? 'Webkit'
                                  : n.userAgents.gecko.test(a)
                                    ? 'Gecko'
                                    : n.userAgents.msie.test(a)
                                      ? 'MSIE'
                                      : window.opera
                                        ? 'Opera'
                                        : 'other';
                              ...
                              for (i in t)
                                (o = 'object' === v()(t[i]) ? t[i][e] || t[i].other : t[i]) &&
                                  (r[r.length] = i + ':' + o + ' !important;');
                              return r.join('');
                            },
                          },
                          {
                ...
                (function (t) {
                  var e = (function (t) {
                    function e(t) {
                      ...
                      return new z.a({ text: t.title }).appendTo(n.el()), n;
                    }
                    return (
                      U()(e, t),
                      M()(e, [
                          ...
                          o.memoizer.markup ||
                            (o.memoizer.markup = [
                              ...
                              '<span id="{0}-container" class="IN-' +
                                o.config.position +
                                ('hidden' === o.config.state ? ' IN-hidden' : '') +
                                '">',
                              '<span id="{0}" class="IN-' + o.config.position + '">',
                              '<span id="{0}-inner" class="IN-' + o.config.position + '">',
                              '<span id="{0}-content" class="IN-' + o.config.position + '">{1}</span>',
                              '</span>',
                              '</span>',
                              '</span>',
                              '',
                            ...
                            case 'top':
                              s.push(
                                [
                                  ...
                                  o.createStyle({ 'text-indent': '-999px', display: 'inline-block' }),
                                  '}',
                                  '',
                                ].join(''),
                              );
                          }
                          s.push(['#{0}-container.IN-hidden #{0} {', o.createStyle({ display: 'none' }), '}'].join('')),
                            (o.memoizer.styles = s.join(''));
                        }
                        return (
                          t.Util.addCSS(t.Util.formatString(o.memoizer.styles, i)),
                              ...
                              for (
                                var e = {
                                    ...
                                    flat: {
                                      ...
                                      top: {
                                        countBubble: { background: { position: '-207px -470px' }, color: '#4e4e4e' },
                                        width: '60px',
                                      },
                                      topEmpty: {
                                        countBubble: {
                  ...
                  var e = {},
                    n = (function (n) {
                      function r() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        P()(this, r),
                          (t = { text: t.text || '', size: (t.size || 'small').toLowerCase(), suppressFont: !0 });
                        var n = R()(this, (r.__proto__ || D()(r)).call(this, t));
                        (n.config = t),
                          (n.memoizer = e[n.config.text] = e[n.config.text] || {}),
                          (n.size = n.config.size),
                          (n.sizeSettings = { small: { height: 16, width: 16, logo: [-92, -42] } });
                        var o = n.generateId();
                        return (
                          n.memoizer.markup ||
                            (n.memoizer.markup = [
                          ...
                          n.memoizer.styles ||
                            (n.memoizer.styles = ['', n.getBaseStyles(t), ''].join('').replace(/\{ID\}/g, '{0}')),
                          ...
                          },
                          {
                            ...
                            value: function (t) {
                              return void 0 === this.sizeSettings[this.size]
                                ? this.sizeSettings.small[t]
                                : this.sizeSettings[this.size][t];
                            },
                          },
                          {
                            key: 'getBaseStyles',
                    ...
                    a = (function (e) {
                      function i() {
                        ...
                        return (
                          ...
                          (e.anchor = t.anchor),
                          (e.events = new W.a({ placed: !1 })),
                          (e.method = t.method),
                          (e.width = t.width),
                          (e.height = t.height),
                          (e.onWindowCreate = Y.call(e, 'ready')),
                          (e.onWindowRemove = Y.call(e, 'close')),
                          (e.onWindowResize = Y.call(e, 'resize')),
                          e
                        );
                      }
                      return (
                              ...
                              e &&
                                (this.anchor
                                  ? ((i = s.self),
                                    ...
                                    Object(H.c)(s.self, e),
                                    IN.Objects.Lib.anchor(this.anchor.fixed, s.self, this.anchor.context),
            ...
            function X(t) {
              return [
                { fixed: 'tr', movable: 'tl', offsetY: -1 * t },
                { fixed: 'tl', movable: 'tr', offsetY: -1 * t },
                { fixed: 'bl', movable: 'br', offsetY: t },
                { fixed: 'br', movable: 'bl', offsetY: t },
                { fixed: 'tl', movable: 'br', offsetY: t },
              ...
              !(function (t) {
                Sslac.Class('IN.Tags.Base')
                  ...
                  .Method('parseAttribute', function (e, n) {
                    ...
                    for (var r = 0, o = (e = e.split(',')).length; r < o; r++)
                      (e[r] = t.Util.trim(e[r])), 'callback' === n && (e[r] = Sslac.valueOf(e[r]));
                    return e;
                  })
                  ...
                  Sslac.Class('IN.Tags.Alumni')
                    ...
                    .Method('createFrame', function () {
                      ...
                      this.width > 0 && (e.width = this.width),
                        new IN.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.alumni_url })
                          .params(e)
                          .place(this.el());
                    }),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.CompanyInsider')
                    ...
                    .Constructor(function (t, e) {
                      this.Parent(t, e),
                        e.id && ((this.id = e.id), (this.modules = e.modules || ''), this.createFrame());
                    })
                    .Method('createFrame', function () {
                      var e = { companyIdentifier: this.id, modules: this.modules };
                      (this.el().innerHTML = ''),
                        new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.company_insider_url })
                          .params(e)
                          .place(this.el());
                    }),
                  ...
                  Sslac.Class('IN.Tags.CompanyProfile')
                    ...
                    .Constructor(function (t, e) {
                      this.Parent(t, e),
                        e.id &&
                          ...
                          'inline' === this.format &&
                            ((this.width = parseInt(e.width, 10) - 14),
                    ...
                    .Method('createFrame', function () {
                      var e = this,
                        ...
                        i = void 0;
                      if (
                        ('false' === this.related && (n.related = !1),
                        this.width > 0 && (n.width = this.width),
                        'inline' === this.format)
                      )
                        (this.el().innerHTML = ''),
                          new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.company_url })
                            .params(n)
                            .place(this.el());
                      else {
                          ...
                          t.Event.on(i, a, function () {
                            e.open ||
                              ...
                              (o = new t.Objects.SmartWindow(
                                {
                                  mode: 'hovercard',
                                  anchor: { fixed: i.el(), movable: null, context: r },
                                  url: t.ENV.widget.company_url,
                                },
                                e,
                              ).params(n)).ready(function () {
                                i.setState('normal');
                              }),
                              o.place(e.el()),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.CsapBeacon')
                    ...
                    .Constructor(function (e, n) {
                      ...
                      if (!r.activity)
                        try {
                          ...
                          if (o) {
                            ...
                            for (
                              var s = document.getElementsByTagName('img'), u = '?' + t.ENV.auth.api_key + '_', c = 0;
                              c < s.length;
                              ++c
                            ) {
                              var f = s[c],
                      ...
                      new t.Objects.SmartWindow({ mode: 'invisible', url: t.ENV.widget.csap_beacon_url })
                        .params(r)
                        .place(this.el());
                    }),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.Followmember')
                    ...
                    .Method('createFrame', function () {
                      ...
                      this.width > 0 && (e.width = this.width),
                        new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.followmember_url })
                          .params(e)
                          .place(this.el());
                    }),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.FullMemberProfile')
                    ...
                    .Method('createFrame', function () {
                      ...
                      (e.api_key = n),
                        this.width > 0 && (e.width = this.width),
                        new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.full_member_profile_url })
                          .params(e)
                          .place(this.el());
                    }),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.jymbii')
                    ...
                    .Constructor(function (e, n) {
                      ...
                      if ('inline' === o) {
                        var s = new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.jymbii_url }).params(a);
                        if (a.callback)
                          for (var u = this.parseAttribute(n.callback, 'callback'), c = 0, f = u.length; c < f; c++)
                            s.success(u[c], this);
                        s.place(this.el());
                      } else {
                        var l = new t.Objects.InLink({ text: n.text }),
                            ...
                            function () {
                              if (!this.open) {
                                ...
                                var e = new t.Objects.SmartWindow(
                                  {
                                    mode: 'hovercard',
                                    anchor: { fixed: l.el(), movable: null, context: r },
                            ...
                            i
                              .result(function (t) {
                                (t = (function (t) {
                                  ...
                                  e
                                    ? ((this.twoLeggedDone = !0), this.mergeResults(t, 'twoLegged'))
                                    : ((this.threeLeggedDone = !0), this.mergeResults(t, 'threeLegged'));
                              }, this)
                              .error(function (t) {
                                e
                                  ? ((this.twoLeggedDone = !0), this.mergeResults({}, 'twoLegged'))
                                  : ((this.threeLeggedDone = !0), this.mergeResults({}, 'threeLegged'));
                  ...
                  Sslac.Class('IN.Tags.MemberProfile')
                    ...
                    .Method('createFrame', function () {
                      var e = this,
                        ...
                        i = void 0;
                      if (
                        (/false/.test(this.related) && (n.related = !1),
                        this.width > 0 && (n.width = this.width),
                        'inline' === this.format)
                      )
                        (this.el().innerHTML = ''),
                          new t.Objects.SmartWindow({ mode: 'embedded', url: t.ENV.widget.member_profile_url })
                            .params(n)
                            .place(this.el());
                      else {
                        var a = 'click' === this.format ? 'click' : 'mouseover';
                        ...
                        function i() {
                          ...
                          this.clickedOnce || (this.clickedOnce = !0),
                            this.url
                              ...
                              : ((e = this.companyId),
                                (n = this.productId),
                                (r = t.ENV.widget.recommend_product_url
                                  .replace(/\{COMPANY_ID\}/g, e)
                                  .replace(/\{PRODUCT_ID\}/g, n))),
                            window.open(Object($.sanitizeUrl)(r));
                        }
                        if (
                          ((this.button = new t.Objects.Button({ title: 'Recommend' })),
                          ...
                          if (
                            ((function (n, r) {
                              var o = document.createElement('script'),
                                ...
                                a = (function (e, n, r) {
                                  return t.ENV.widget.recommend_product_counter_url
                                    .replace(/\{PRODUCT_ID\}/g, n)
                                    .replace(/\{CALLBACK\}/g, r);
                                })(0, n.productId, i);
                              e || (e = document.getElementsByTagName('head')[0]),
                                (o.type = 'text/javascript'),
                                (o.src = Object($.sanitizeUrl)(a)),
                                e.appendChild(o);
                            })({ url: this.url, companyId: this.companyId, productId: this.productId }, this),
                ...
                (function (t) {
                  Sslac.Class('IN.Tags.Share')
                    ...
                    .Method('makeButton', function () {
                      ...
                      function s() {
                        ...
                        this.trk && (e.trk = this.trk),
                          ...
                          this.winObj && (this.successCallbacks.pop(), this.winObj.remove(), (this.winObj = null)),
                          ...
                          this.successCallbacks.push(function () {
                            if (i.useCounter) {
                              ...
                              (t.type = 'text/javascript'),
                                (t.src = Object($.sanitizeUrl)(o(i.url) + '&cc=' + i.count)),
                                a.appendChild(t);
                            }
                          }),
                            n = 0,
                            r = this.successCallbacks.length;
                          n < r;
                          n++
                        )
                          this.winObj.success(this.successCallbacks[n]);
                        for (n = 0, r = this.errorCallbacks.length; n < r; n++)
                          this.winObj.error(this.errorCallbacks[n]);
                        this.winObj.place();
                      }
                      if (
                        ((this.button = new t.Objects.Button({ title: t.i18n.get('share'), theme: this.theme })),
                        this.button.place(this.el()),
                    ...
                    .Method('setCountFormatted', function (e) {
                      if (t.Util.isObject(e)) {
                        if (!e.fCnt && e.count) this.setCount(e.count);
                          ...
                          this.counter &&
                          ('' !== e.count || 'top' === this.position || 'talltop' === this.position)
                        ) {
                    ...
                    .Method('plusOne', function () {
                      this.countData
                        ? ((this.countData.fCnt = this.countData.fCntPlusOne), this.setCountFormatted(this.countData))
                        : this.increaseCount();
                    })
                        ...
                        if (
                          ...
                          window.setTimeout(function () {
                            for (var t = 0, e = f.length; t < e; t++)
                              f[t].parentNode && f[t].parentNode.removeChild(f[t]);
                          }, 100),
                            p(n[i], a),
                            p(r[i], t);
                        }
                        function p(t, e) {
                          if (t) for (l = 0, d = t.length; l < d; l++) (c = t[l]).callback.call(c.scope, e);
                        }
                      })(t);
                    });
                  var e = void 0,
                  ...
                  function i(t, n, r, i) {
                    e || (e = document.getElementsByTagName('head')[0]),
                      t[n] || (t[n] = []),
                      t[n].push({ callback: r || function () {}, scope: i || window });
            ...
            function at(t, e) {
              ...
              return (
                t.options.normalize('deferParse', function (t) {
                  (t = !t),
                ...
                (function (t) {
                  (t.ENV = o()({}, t.ENV || {}, {
                    ...
                    widget: {
                      ...
                      recommend_product_counter_url:
                        u + '/company/api/recommendation/count?type=PDCT&id={PRODUCT_ID}&callback={CALLBACK}',
                    ...
                    [
                      ...
                      { previous: 'api_key', current: 'apiKey', target: t.ENV.auth },
                    ].forEach(function (e) {
                      var n = e.previous || e,
                        r = e.current || e,
                        o =
                ...
                (function (t) {
                  ...
                  function n(t, n, r, o, i, a) {
                    return (
                      o &&
                        (console.error('[stubEvent.on] Use .bind instead of passing scope', arguments),
                        (r = r.bind(o))),
                      i && console.error('[stubEvent.on] obj not supported on event', arguments),
                      e(t, function (t) {
                        t.events
                          ? t.events[a ? 'once' : 'on'](n, r)
                          : t.addEventListener
                            ? (a &&
                            ...
                            : console.error('[stubEvent.on] unknown type', t);
                      }),
                      r
                    );
                  }
                  ...
                  (e.deprecate = function () {}),
                    (t.Util = [
                      ...
                      },
                      {
                        ...
                        isNode: function (t) {
                          return (
                            e.deprecate('isNode', 'will be removed in a future release'),
                            'object' === ('undefined' == typeof Node ? 'undefined' : v()(Node))
                              ? t instanceof Node
                        ...
                        isElement: function (t) {
                          return (
                            e.deprecate('isElement', 'will be removed in a future release'),
                            'object' === ('undefined' == typeof HTMLElement ? 'undefined' : v()(HTMLElement))
                        ...
                        isRetina: function () {
                          return (
                            e.deprecate('isRetina', 'will be removed in a future release'),
                  ...
                  t.UI = {
                    Authorize: function () {
                      var e = [
                          '',
                          t.ENV.url.authorize,
                          -1 === t.ENV.url.authorize.indexOf('?') ? '?' : '&',
                          'client_id=' + t.ENV.auth.api_key,
                          '&type=user-agent',
                          '',
                        ].join(''),
                        n = void 0;
                      return (
                        t.ENV.js.scope && t.ENV.js.scope.length && (n = { scope: t.ENV.js.scope.join(' ') }),
                        new t.Objects.SmartWindow({ url: e, mode: 'popup', postParams: n })
                      );
                    },
                    SilentAuth: function () {
                      var e = [
                          '',
                          t.ENV.url.silent_auth_url,
                          -1 === t.ENV.url.silent_auth_url.indexOf('?') ? '?' : '&',
                          'client_id=' + t.ENV.auth.api_key,
                          '&type=user-agent',
                          '',
                        ].join(''),
                    ...
                    WidgetSignin: function (e) {
                      ...
                      return (
                        (e = e || {}),
                        new t.Objects.SmartWindow({ url: n, mode: 'popup', existingPopup: e.existingPopup || null })
                      );
                    },
                    Logout: function () {
                ...
                (function (t) {
                  var e,
                    n = t.logger.create('Support'),
                    r =
                      ((e = 'unknown'),
                      window.self === window.top && window.opener && (e = 'popup'),
                      window.parent && window.parent !== window.self && (e = 'iframe'),
                      window.self !== window.top || window.opener || (e = 'page'),
                      e);
                  function o() {
                    return 'popup' === r;
                  }
                  ...
                  function s() {
                    if (!a)
                      throw n.Error(new Error('No XD object is available from this page: ' + window.location.href));
                    function t(t) {
                      return function (e) {
                  ...
                  t.Support = {
                    ...
                    isSingleJS: function () {
                      var t = { iosAll: /OS .* like Mac OS X/i },
                    ...
                    appendField: function (t) {
                      console.warn('TODO - IN.Support.appendField [done?]'),
                        (i() ? window.parent : window.opener).appendField(t);
                    },
                          ...
                          },
                          {
                            ...
                            value: function (e) {
                              this.callQueue.forEach(function (e) {
                                t.api
                                  .request(e.resource, { method: e.method, params: e.params, body: e.postBody })
                        ...
                        return (
                          M()(e, [
                            ...
                            },
                            {
                              ...
                              value: function () {
                                return (
                                  this.addHandler(this.handlers.errors, [].slice.apply(arguments)), this.get(), this
                                );
                              },
                            },
                            {
                            ...
                            },
                            {
                              ...
                              value: function (e) {
                                ...
                                if (i) for (var s in e) s !== r && (o[s] = e[s]);
                                return { values: a, meta: o };
                              },
                            },
                            {
                              key: 'getParams',
                              ...
                              value: function () {
                                ...
                                return (
                                  this.getParams().postFields &&
                                    ((e = '/posts'), (postBody = this.getParams().postFields.join(''))),
                                  t.API.Raw('/posts/' + this.getParams().id + e)
                                    .body(postBody)
                                    .method('POST')
                                );
                              },
                          ...
                          M()(e, [
                            {
                              ...
                              value: function () {
                                var t = [].slice.apply(arguments);
                                return (
                                  (t && t.length) || (t = ['name', 'code', { buckets: ['code', 'name', 'count'] }]),
                              ...
                              value: function () {
                                ...
                                return (
                                  ...
                                  this.getParams().fields
                                    ? t.push('people:({FIELDS})')
                                    : t.push(
                                        [
                                          'people:(',
                                          ['id', 'first-name', 'last-name', 'headline', 'picture-url'].join(','),
                                          ')',
                                        ].join(''),
                                      ),
                            ...
                            },
                            {
                              key: 'format',
                              value: function (t) {
                                return ot()(e.prototype.__proto__ || D()(e.prototype), 'format', this).call(
                                  this,
                                  t,
                                  'people.values',
                                );
                              ...
                              value: function () {
                                ...
                                return (
                                  this.getParams().commentFields &&
                                    ((e = '/comments'), (postBody = this.getParams().commentFields.join(''))),
                                  t.API.Raw('/posts/' + this.getParams().id + e)
                                    .body(postBody)
                                    .method('POST')
                                );
                    ...
                    (function (t) {
                      var e = (function (e) {
                        function n() {
                          ...
                          var t = R()(this, (n.__proto__ || D()(n)).call(this, arguments));
                          return (
                            (t.defaultFields = ['id', 'first-name', 'last-name', 'headline', 'picture-url']),
            ...
            t.exports = function (t, e, n, m, g, y) {
              ...
              return (
                ...
                (y ||
                  ...
                  : ((w = m.getConstructor(e, t, g, x)), u(w.prototype, n), (i.NEED = !0)),
                d(w, t),
                (k[t] = w),
                o(o.G + o.W + o.F, k),
                y || m.setStrong(w, t, g),
          ...
          function (t, e, n) {
            ...
            var r,
                          ...
                          try {
                            s
                              ? (o || (2 == t._h && D(t), (t._h = 1)),
                                ...
                                n === e.promise ? c(k('Promise-chain cycle')) : (i = P(n)) ? i.call(n, u, c) : u(n))
                              : c(r);
                          } catch (t) {
                            f && !a && f.exit(), c(t);
                          }
              ...
              D = function (t) {
                g.call(u, function () {
                  var e;
                  I ? S.emit('rejectionHandled', t) : (e = u.onrejectionhandled) && e({ promise: t, reason: t._v });
                });
              },
              B = function (t) {
                var e = this;
              ...
              n(24)(function () {
                ...
                ? function (t, e) {
                    for (var n = s(t), c = arguments.length, f = 1, l = i.f, d = a.f; c > f; )
                      for (var p, h = u(arguments[f++]), v = l ? o(h).concat(l(h)) : o(h), m = v.length, g = 0; m > g; )
          ...
          function (t, e, n) {
            var r = n(11);
            r(r.P + r.R, 'Set', { toJSON: n(153)('Set') });
          },
          function (t, e, n) {
            n(154)('Set');
          },
              ...
              (function (t) {
                ...
                !(function () {
                  ...
                  for (var r = 2, o = 0; o < 64; )
                    e(r) && (o < 8 && (s[o] = n(t.pow(r, 0.5))), (u[o] = n(t.pow(r, 1 / 3))), o++), r++;
                })();
                var c = [],
                  f = (a.SHA256 = i.extend({
                    _doReset: function () {
          ...
          function (t, e, n) {
            var r = n(11);
            r(r.P + r.R, 'Map', { toJSON: n(153)('Map') });
          },
          function (t, e, n) {
            n(154)('Map');
          },
          ...
          function (t, e, n) {
            ...
            var D = {
              ...
              B = new j.a({ namespace: 'IN:Options' });
            function R() {
              if (A()(this.options)) {
                for (var t = arguments.length, e = Array(t), n = 0; n < t; n++) e[n] = arguments[n];
                throw B.Error(
                  new Error('Cannot modify options once the framework has initialized (' + e.join(':') + ')'),
                );
              }
            }
            var F = (function (t) {
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        for (var r = arguments.length, o = Array(r > 1 ? r - 1 : 0), i = 1; i < r; i++)
                          o[i - 1] = arguments[i];
                        (n = k()(e.prototype.__proto__ || b()(e.prototype), 'emit', this)).call.apply(
                          n,
                          [this, t].concat(o),
                        );
                      },
                  ...
                  l()(t, [
                    {
                      ...
                      value: function (t) {
                        ...
                        return new i.a(function (r, o) {
                          ...
                          if (l)
                            switch (
                              (l instanceof HTMLFormElement &&
                                (l = v()(l.querySelectorAll('input')).reduce(function (t, e) {
                          ...
                          (f = H()(f)),
                            e.proxy.on('ready', function () {
                              e.proxy.request({ resource: t, method: s, body: l, headers: f, params: u }).then(
                                function (t) {
                                  r(t);
                                },
                                function (t) {
                  ...
                  l()(e, [
                    {
                      ...
                      value: function (t) {
                        ...
                        return (
                          'string' == typeof e && (e = this.registry[t] = Z(Object(Y.c)(e, this.options.params))), e
                        );
                      },
                    },
                    {
                                  ...
                                  ? o.then(function () {
                                      e.registry[t]
                                        ...
                                        : r(
                                            e.logger.Error(
                                              'get',
                                              new Error("Extension '" + t + "' was loaded but not registered"),
                                            ),
                                          );
                                    }, r)
                                  : r(e.logger.Error('get', new Error("Unknown type '" + t + "'")));
                              })
                        );
                      },
                    },
                  ...
                  l()(t, [
                    {
                      ...
                      value: function (t) {
                        ...
                        return !o || rt.test(o)
                          ? i.a.resolve()
                          : new i.a(function (r, i) {
                              t && t.setAttribute && t.getAttribute && it(t, n + '+init'),
                                e.core.tags.get(o).then(
                                  function (n) {
                                    setTimeout(function () {
                                      try {
                                        ...
                                        (t.message = "Could not instantiate tag for '" + o + "': " + t.message),
                                          i(e.logger.Error(t));
                                      }
                                    }, 0);
                                  },
            ...
            function dt(t) {
              for (
                var e = '', n = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~', r = 0;
                r < t;
                r++
              )
                ...
                l()(t, [
                  {
                    ...
                    value: function (t) {
                      var e = this;
                      return (
                        (t.isAuthenticated = !!t.oauthToken),
                        p()(t).reduce(
                          function (n, r) {
            ...
            var mt = {
              ...
              yt = (function () {
                function t(e) {
                  ...
                  if (e.options.get('apiKey')) {
                    ...
                    (this.events = new st.a({ authenticate: !1, unauthenticate: !1, change: !1, ready: !0 })),
                    ...
                    var o = function (t) {
                        ...
                        var r,
                          ...
                          a,
                          s,
                          u = n.credentials.update(t);
                        return u
                          ? ((r = t.authCookie),
                            (o = e.options),
                            (a = 'linkedin_oauth_' + o.get('apiKey')),
                            (s = a + '_crc'),
                            new i.a(function (t) {
                              setTimeout(function () {
                                r
                                  ? (mt.write({ name: a, value: r, secure: !0 }),
                                    o.get('credentialsCookieCrc') && mt.write({ name: s, value: Object(gt.a)(r) }))
                                  : (mt.clear(a), mt.clear(s)),
                                  setTimeout(function () {
                                    t();
                                  }, 0);
                              }, 0);
                    ...
                    (this.refresh = function () {
                      ...
                      (this.refreshOAuthAccessToken = function (t, e, n) {
                        return new i.a(function (r, i) {
                          s()
                            .getOauthAccessToken(t, e, n)
                            .then(function (t) {
                              o({ oauthToken: t.access_token }), r(t);
                            })
                            .catch(function (t) {
                      ...
                      (this.logout = function () {
                        return new i.a(function (t, r) {
                          var o = new W.a(e.options.get('urls.logout'), {
                            refresh: !1,
                            params: { oauth_token: n.credentials.oauthToken, api_key: e.options.get('apiKey') },
                          });
                      ...
                      (this.authorizeV2 = function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                          r = t.scope;
                        return n.credentials.isAuthenticated
                          ? i.a.resolve(n.credentials)
                          : new i.a(function (t, o) {
                                ...
                                u = new W.b(e.options.get('urls.pkceAuthorization'), {
                                  ...
                                  adjustParams: function (t) {
                                    var e = t.redirect_uri,
                                      n = t.xdOrigin;
                                    t.redirect_uri = Object(Y.c)(e, { xdOrigin: n });
                                  },
                                  height: 600,
                                }),
                                c = new V.a(u, a);
                              s(),
                                c.on('ready', function (e) {
                                  e && e.state && e.state === i.state && e.code
                                    ? n
                                        .refreshOAuthAccessToken(e.code, i.code_verifier, u.params.redirect_uri)
                                        .then(t)
                                        .catch(o)
                                    : o('Error: OAuth State mismatch');
                                });
                            });
                      });
                  }
                  function s() {
                    return (a =
                      a ||
                      ((t = new W.a(e.options.get('urls.userSession'), {
                        refresh: !1,
                        params: {
                      ...
                      (n = new V.a(t)),
                      ['getCredentials', 'getOauthAccessToken'].forEach(function (t) {
                        n[t] =
                          n[t] ||
                          function () {
                            for (var e = arguments.length, r = Array(e), o = 0; o < e; o++) r[o] = arguments[o];
              ...
              kt = (function (t) {
                function e() {
                  ...
                  return (
                    (i.supported = { events: ['resize', 'disconnect', 'close', 'reload'], methods: [] }),
                    t.methods &&
                      p()(t.methods).forEach(function (e) {
                        ...
                        this.supported.methods.forEach(function (t) {
                          e.messenger.on(t, function () {
                            ...
                            if ('function' != typeof e[t])
                              e.messenger.error({ code: -32601, message: "Method not found '" + t + "'" }, i.id);
                            else
                              try {
                                var a = e[t].apply(e, r);
                                a && a.then
                          ...
                          this.send('ready', { source: window.location.href, supported: this.supported, data: t }),
                          function () {
                            var t = this,
                              e =
                              ...
                              r = (function (t) {
                                ...
                                var r,
                                  ...
                                  a =
                                    ...
                                    (i = o.height),
                                    { width: r === document.body ? r.scrollWidth : o.width, height: i });
            ...
            function ae(t, e, n) {
              ...
              e &&
                $t(t) &&
                ((o = (t.offsetWidth > 0 && re(r.width) / t.offsetWidth) || 1),
                (i = (t.offsetHeight > 0 && re(r.height) / t.offsetHeight) || 1));
              var a = (Xt(t) ? Qt(t) : window).visualViewport,
                ...
                f = r.width / o,
                l = r.height / i;
              return { width: f, height: l, top: c, right: u + f, bottom: c + l, left: u, x: u, y: c };
            }
            function se(t) {
              var e = ae(t),
                n = t.offsetWidth,
            ...
            function he(t) {
              ...
              return n && ('html' === qt(n) || ('body' === qt(n) && 'static' === ce(n).position))
                ? e
                : n ||
                    (function (t) {
            ...
            function _e(t) {
              var e,
                ...
                h = a.y,
                v = void 0 === h ? 0 : h,
                m = 'function' == typeof f ? f({ x: p, y: v }) : { x: p, y: v };
              (p = m.x), (v = m.y);
              ...
              if (c) {
                var _ = he(n),
                  ...
                  S = 'clientWidth';
                _ === Qt(n) &&
                  'static' !== ce((_ = le(n))).position &&
                  'absolute' === s &&
                  ((k = 'scrollHeight'), (S = 'scrollWidth')),
                  (_ = _),
                  (o === St || ((o === At || o === Et) && i === Ct)) &&
                    ((w = Ot),
                    (v -= (l && _ === x && x.visualViewport ? x.visualViewport.height : _[k]) - r.height),
                    (v *= u ? 1 : -1)),
                  (o !== At && ((o !== St && o !== Ot) || i !== Ct)) ||
                    ((b = Et),
                    (p -= (l && _ === x && x.visualViewport ? x.visualViewport.width : _[S]) - r.width),
                    (p *= u ? 1 : -1));
              }
              var O,
                E = Object.assign({ position: s }, c && xe),
                A =
                  !0 === f
                    ? (function (t, e) {
                        var n = t.x,
                        ...
                        return { x: re(n * o) / o || 0, y: re(r * o) / o || 0 };
                      })({ x: p, y: v }, Qt(n))
                    : { x: p, y: v };
              return (
                (p = A.x),
                ...
                u
                  ...
                  : Object.assign(
                      {},
                      E,
                      (((e = {})[w] = y ? v + 'px' : ''), (e[b] = g ? p + 'px' : ''), (e.transform = ''), e),
                    )
              );
            }
            var ke = {
            ...
            function Te(t, e) {
              ...
              void 0 === e && (e = []);
              var r = (function t(e) {
                  return ['html', 'body', '#document'].indexOf(qt(e)) >= 0
              ...
              return e === Tt
                ? Me(
                    (function (t, e) {
                      ...
                      return { width: i, height: a, x: s + Ce(t), y: u };
                    })(t, n),
                  )
                : Xt(e)
                  ? (function (t, e) {
                  ...
                  : Me(
                      (function (t) {
                        var e,
                          ...
                          u = -r.scrollTop;
                        return (
                          'rtl' === ce(o || n).direction && (s += ee(n.clientWidth, o ? o.clientWidth : 0) - i),
            ...
            function Be(t, e) {
              ...
              var n = e,
                  ...
                  var o =
                    ...
                    s = i.reduce(
                      function (e, n) {
                        var o = Le(t, n, r);
                        return (
                          (e.top = ee(o.top, e.top)),
                          (e.right = ne(o.right, e.right)),
                          (e.bottom = ne(o.bottom, e.bottom)),
                          (e.left = ee(o.left, e.left)),
                          e
                        );
                      },
                      Le(t, a, r),
                ...
                k = De({ reference: _, element: b, strategy: 'absolute', placement: o }),
                ...
                if (!e.modifiersData[r]._skip) {
                  for (
                          ...
                          te(n) === It
                            ? (function (t, e) {
                                ...
                                var p = d.reduce(function (e, n) {
                                  return (
                                    (e[n] = Be(t, { placement: n, boundary: o, rootBoundary: i, padding: a })[te(n)]), e
                                  );
                                }, {});
                    ...
                    var E = b[O],
                      ...
                      j = [St, Ot].indexOf(A) >= 0,
                      N = j ? 'width' : 'height',
                      C = Be(e, { placement: E, boundary: f, rootBoundary: l, altBoundary: d, padding: c }),
                      P = j ? (I ? Et : At) : I ? Ot : St;
                    w[N] > x[N] && (P = Ae(P));
                    var T = Ae(P),
                      M = [];
            ...
            var ze = {
                ...
                fn: function (t) {
                  var e = t.state,
                    ...
                    a = Be(e, { elementContext: 'reference' }),
                    s = Be(e, { altBoundary: !0 }),
                    u = Fe(a, r),
                    c = Fe(s, o, i),
                    f = Ue(u),
                    l = Ue(c);
                      ...
                      return (
                        (t[n] = (function (t, e, n) {
                          var r = te(t),
                            ...
                            s = i[1];
                          return (
                            (a = a || 0), (s = (s || 0) * o), [At, Et].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s }
                          );
                        })(n, e.rects, i)),
                        t
                      );
              ...
              Ve = {
                ...
                fn: function (t) {
                  var e = t.state,
                    ...
                    h = n.tetherOffset,
                    v = void 0 === h ? 0 : h,
                    m = Be(e, { boundary: u, rootBoundary: c, padding: l, altBoundary: f }),
                    g = te(e.placement),
                    y = we(e.placement),
                    b = !y,
                    w = ve(g),
                    ...
                    k = e.rects.reference,
                    S = e.rects.popper,
                    O = 'function' == typeof v ? v(Object.assign({}, e.rects, { placement: e.placement })) : v,
                    E =
                      'number' == typeof O
                      ...
                      return (
                        ...
                        s.orderedModifiers.forEach(function (t) {
                          ...
                          if ('function' == typeof o) {
                            var i = o({ state: s, name: e, instance: f, options: r });
                            u.push(i || function () {});
                          }
                        }),
                        f.update()
                                  ...
                                  (('body' !== qt(e) || Pe(s)) &&
                                    (c =
                                      (r = e) !== Qt(r) && $t(r)
                                        ...
                                        : Ne(r)),
                                  $t(e)
                                    ? (((f = ae(e, !0)).x += e.clientLeft), (f.y += e.clientTop))
                                    : s && (f.x = Ce(s))),
                                {
                          ...
                          for (var r = 0; r < s.orderedModifiers.length; r++)
                            if (!0 !== s.reset) {
                              var o = s.orderedModifiers[r],
                                ...
                                u = void 0 === a ? {} : a,
                                l = o.name;
                              'function' == typeof i && (s = i({ state: s, options: u, name: l, instance: f }) || s);
                            } else (s.reset = !1), (r = -1);
                        }
                      }
                    },
            ...
            var qe = Ye(),
              Qe = Ye({ defaultModifiers: [Oe, He, ke, Jt, Ge, Re, Ve, be, ze] }),
              Xe = Ye({ defaultModifiers: [Oe, He, ke, Jt] }),
              $e = n(132),
              Ze = n(133),
              Je = {
                Client: V.a,
            ...
            var un = new F(),
              cn = new j.a({ namespace: 'IN:Template' }),
              fn = (function () {
                function t(e) {
                  var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                  ...
                  this.render = (function (t, e, n) {
                    var r = (function (t, e) {
                      ...
                      o = t
                        ...
                        .replace(/"/g, '\\"')
                        .replace(/\r/g, '"')
                        .replace(r.echo, '",arguments[3]($1),"')
                        .replace(r.open, '");')
                        .replace(r.close, ';arguments[1].push("'),
                      i = new Function(
                ...
                return l()(t, [{ key: 'render', value: function (t) {} }]), t;
              })(),
              ln = n(134);
            function dn(t, e) {
              t &&
                ('string' == typeof t && (t = t.split(/\s*,\s*/g)),
            ...
            function pn(t) {
              ...
              v()(t.getElementsByTagName('script'), function (t) {
                ...
                (this.isParsed = !0),
                this.events.parse(),
                this.throttled.has(t) && (clearTimeout(this.throttled.get(t)), this.throttled.delete(t));
            }
            var hn,
              vn = (function () {
                function t(e) {
                  ...
                  c()(this, t),
                    ...
                    (this.logger = new j.a({ namespace: 'IN', warn: !this.options.get('suppressWarnings') })),
                    (this.i18n = new nn(this)),
                    ...
                    (this.extensions = new tt(this, { params: { version: this.version } })),
                    (this.parser = new at(this)),
                    ...
                    (this.cws = { poweredByXDoor: '@linkedin/xdoor-sdk' === L().framework }),
                    (this.debug = P.a);
                }
                return (
                  l()(t, [
                        ...
                        this.events.on('ready', function () {
                          ...
                          dn(e.options.get('beforeInit'), function (t) {
                            ...
                            e.options.get('apiKey') &&
                              (e.options.get('urls.apiProxy') && (e.api = new K(e)),
              ...
              On =
                ((hn = {}),
                v()(document.querySelectorAll('script')).forEach(function (t) {
                  (function (t) {
                    ...
                    en()(
                      ...
                      (function (t) {
                        ...
                        return (
                          t &&
                            (t.src &&
                              'true' === (e = z()({}, Object(xt.c)(t.src), Object(xt.b)(t.src))).async &&
                              ((e.init = !1), delete e.async),
                            wn
                              .reduce(function (t, e) {
                                return t.replace(e, '');
                              }, t.textContent)
            ...
            Object(kn.b)(En),
              En.options.get('compat') && 'sdk' !== En.options.get('mode') && (window.IN = Object(Sn.a)(window.IN, {})),
              (e.default = En);
          },
        ]));
    },
